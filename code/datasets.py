...
class Custom_Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        image_fn = row['name']
        # image_path = f"{self.cfg.img_folder}/{row['name']}"
...
class Custom_Collator(object):
    def __init__(self, cfg):
        self.cfg = cfg
        self.clip_model, _ = clip.load(self.cfg.clip_variant, device="mps", jit=False)
        _, self.clip_preprocess = clip.load(self.cfg.clip_variant, device="mps", jit=False)
